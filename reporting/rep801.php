...
function getTaxTransactions($from, $to, $tax_id,$pos)
{
	...
	if ($pos)
		$sql .= "AND custom_pos=".db_escape($pos)." " ;
	if ($tax_id)
		$sql .= "AND tax_id<>'' ";
...
function print_sales_summary_report()
{
	...
	$rep = new FrontReport(_('Pos Sales Summary Report '), "SalesSummaryReport", user_pagesize(), 9, $orientation);
	...
	$totalnet = 0.0;
	$totaltax = 0.0;
	$transactions = getTaxTransactions($from, $to, $tax_id,$pos);
