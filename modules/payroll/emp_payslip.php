...
if (isset($_GET['ModifyPaySlip'])) {
	...
	$_SESSION['page_title'] = _($help_context = "Manage Employee Payslip");
...
if (isset($_GET['AddedID'])) 
{
	...
	$trans_type = ST_JOURNAL;
   	...
   	display_notification_centered( _("Employee Payslip has been entered") . " #$trans_no");

        display_note(get_gl_view_str($trans_type, $trans_no, _("&View this Employee Payslip")));

	reset_focus();
	hyperlink_params($_SERVER['PHP_SELF'], _("Enter &Employee Payslip"), "NewPayslip=Yes");
