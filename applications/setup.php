...
class setup_app extends application
{
	function setup_app()
	{
		...
		$this->add_lapp_function(0, _("Manage &Company Setup"),
		...
		$this->add_lapp_function(0, _("Manage &Access Setup"),
			"admin/security_roles.php?", 'SA_SECROLES', MENU_SETTINGS);
		$this->add_lapp_function(0, _("Manage &Display Setup"),
			"admin/display_prefs.php?", 'SA_SETUPDISPLAY', MENU_SETTINGS);
		$this->add_lapp_function(0, _("Manage &Forms Setup"),
			"admin/forms_setup.php?", 'SA_FORMSETUP', MENU_SETTINGS);
		$this->add_rapp_function(0, _("Manage &Taxes and Duties"),
			"taxes/tax_types.php?", 'SA_TAXRATES', MENU_MAINTENANCE);
		$this->add_rapp_function(0, _("Manage Tax &Groups"),
			"taxes/tax_groups.php?", 'SA_TAXGROUPS', MENU_MAINTENANCE);
		$this->add_rapp_function(0, _("Manage Item Ta&x Types"),
		...
		$this->add_lapp_function(2, _("&Attach Documents with Transcations"),
			"admin/attachments.php?filterType=20", 'SA_ATTACHDOCUMENT', MENU_MAINTENANCE);
		$this->add_lapp_function(2, _("Current Server &Diagnostics"),
