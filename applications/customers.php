...
class customers_app extends application 
{
	function customers_app() 
	{
		...
		$this->add_lapp_function(0, _("Sales &Quotation "),
		...
		$this->add_rapp_function(0, _("&Delivery Against Sales Orders"),
			"sales/inquiry/sales_orders_view.php?OutstandingOnly=1", 'SA_SALESDELIVERY', MENU_TRANSACTION);
		$this->add_rapp_function(0, _("&Invoice Against Sales Delivery"),
