...
class general_ledger_app extends application
{
	function general_ledger_app()
	{
		...
		$this->add_rapp_function(0, _("Manage Revenue / &Costs Accruals"),
		...
		$this->add_lapp_function(1, _("General Ledger &Inquiry"),
			"gl/inquiry/gl_account_inquiry.php?", 'SA_GLTRANSVIEW', MENU_INQUIRY);
		$this->add_lapp_function(1, _("Cash/Bank Account &Inquiry"),
		...
		$this->add_lapp_function(2, _("Cash/Bank &Accounts"),
